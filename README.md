...
I created this application in pure Javascript over the course of a weekend.
The goal was to create an application which will take information from the
Guardian newspaper API and display them on the page, with a summary of an article
being displayed on the page.

### Technologies

This application was written in pure Javascript as a single page web application
served on a static web server via node http-server.
